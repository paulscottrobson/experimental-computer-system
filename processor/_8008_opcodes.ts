...
private opcode_03(): void { /*** rnc ***/
    this.cycles = this.cycles + 5;if (this.carry == 0) { this.stix = (this.stix - 1) & 7; };;
}
private opcode_04(): void { /*** adi %1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_05(): void { /*** rst 00 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x00;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_06(): void { /*** mvi a,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.a = this.mbr;;
}
private opcode_07(): void { /*** ret ***/
    this.cycles = this.cycles + 5;this.stix = (this.stix - 1) & 7;;
}
...
private opcode_0b(): void { /*** rnz ***/
    this.cycles = this.cycles + 5;if (this.pszv != 0) { this.stix = (this.stix - 1) & 7; };;
}
private opcode_0c(): void { /*** aci %1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_0d(): void { /*** rst 08 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x08;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_0e(): void { /*** mvi b,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.b = this.mbr;;
}
...
private opcode_13(): void { /*** rp ***/
    this.cycles = this.cycles + 5;if ((this.pszv & 0x80) == 0) { this.stix = (this.stix - 1) & 7; };;
}
private opcode_14(): void { /*** sui %1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.mar = this.a - this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_15(): void { /*** rst 10 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x10;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_16(): void { /*** mvi c,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.c = this.mbr;;
}
...
private opcode_1b(): void { /*** rpo ***/
    this.cycles = this.cycles + 5;if (this.parityeven(this.pszv) == 0) { this.stix = (this.stix - 1) & 7; };;
}
private opcode_1c(): void { /*** sbi %1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.mar = this.a - this.mbr - this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_1d(): void { /*** rst 18 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x18;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_1e(): void { /*** mvi d,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.d = this.mbr;;
}
...
private opcode_24(): void { /*** ani %1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.carry = 0;this.a = this.a & this.mbr;this.pszv = this.a;;
}
private opcode_25(): void { /*** rst 20 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x20;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_26(): void { /*** mvi e,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.e = this.mbr;;
}
...
private opcode_2d(): void { /*** rst 28 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x28;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_2e(): void { /*** mvi h,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.h = this.mbr;;
}
...
private opcode_35(): void { /*** rst 30 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x30;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_36(): void { /*** mvi l,%1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.l = this.mbr;;
}
...
private opcode_3c(): void { /*** cpi %1 ***/
    this.cycles = this.cycles + 8;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_3d(): void { /*** rst 38 ***/
    this.cycles = this.cycles + 5;this.t16 = 0x38;this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_3e(): void { /*** mvi m,%1 ***/
    this.cycles = this.cycles + 9;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.mar = ((this.h << 8) | this.l);WRITE(this.mbr,this.mar);;
}
private opcode_3f(): void { /*** ret ***/
    this.cycles = this.cycles + 5;this.stix = (this.stix - 1) & 7;;
}
private opcode_40(): void { /*** jnc %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if (this.carry == 0) { this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
private opcode_41(): void { /*** in 00 ***/
    this.cycles = this.cycles + 8;this.a = this.input00();;
}
private opcode_42(): void { /*** cnc %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if (this.carry == 0) { this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
private opcode_43(): void { /*** in 01 ***/
    this.cycles = this.cycles + 8;this.a = this.input01();;
}
private opcode_44(): void { /*** jmp %2 ***/
    this.cycles = this.cycles + 11;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_45(): void { /*** in 02 ***/
    this.cycles = this.cycles + 8;this.a = this.input02();;
}
private opcode_46(): void { /*** call %2 ***/
    this.cycles = this.cycles + 11;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF;;
}
private opcode_47(): void { /*** in 03 ***/
    this.cycles = this.cycles + 8;this.a = this.input03();;
}
private opcode_48(): void { /*** jnz %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if (this.pszv != 0) { this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
private opcode_49(): void { /*** in 04 ***/
    this.cycles = this.cycles + 8;this.a = this.input04();;
}
private opcode_4a(): void { /*** cnz %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if (this.pszv != 0) { this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
...
private opcode_50(): void { /*** jp %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if ((this.pszv & 0x80) == 0) { this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
private opcode_51(): void { /*** out 08 ***/
    this.cycles = this.cycles + 6;this.output08(this.a);;
}
private opcode_52(): void { /*** cp %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if ((this.pszv & 0x80) == 0) { this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
...
private opcode_58(): void { /*** jpo %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if (this.parityeven(this.pszv) == 0) { this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
private opcode_59(): void { /*** out 0c ***/
    this.cycles = this.cycles + 6;this.output0c(this.a);;
}
private opcode_5a(): void { /*** cpo %2 ***/
    this.cycles = this.cycles + 10;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.mbr;this.mar = this.stack[this.stix];this.stack[this.stix] = (this.mar + 1) & 0x3FFF;this.mbr = READ(this.mar);this.t16 = this.t16 | (this.mbr << 8);if (this.parityeven(this.pszv) == 0) { this.stix = (this.stix + 1) & 7;this.stack[this.stix] = this.t16 & 0x3FFF; };;
}
...
private opcode_80(): void { /*** add a ***/
    this.cycles = this.cycles + 5;this.mbr = this.a;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_81(): void { /*** add b ***/
    this.cycles = this.cycles + 5;this.mbr = this.b;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_82(): void { /*** add c ***/
    this.cycles = this.cycles + 5;this.mbr = this.c;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_83(): void { /*** add d ***/
    this.cycles = this.cycles + 5;this.mbr = this.d;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_84(): void { /*** add e ***/
    this.cycles = this.cycles + 5;this.mbr = this.e;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_85(): void { /*** add h ***/
    this.cycles = this.cycles + 5;this.mbr = this.h;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_86(): void { /*** add l ***/
    this.cycles = this.cycles + 5;this.mbr = this.l;this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_87(): void { /*** add m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.mar = this.a + this.mbr;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_88(): void { /*** adc a ***/
    this.cycles = this.cycles + 5;this.mbr = this.a;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_89(): void { /*** adc b ***/
    this.cycles = this.cycles + 5;this.mbr = this.b;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_8a(): void { /*** adc c ***/
    this.cycles = this.cycles + 5;this.mbr = this.c;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_8b(): void { /*** adc d ***/
    this.cycles = this.cycles + 5;this.mbr = this.d;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_8c(): void { /*** adc e ***/
    this.cycles = this.cycles + 5;this.mbr = this.e;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_8d(): void { /*** adc h ***/
    this.cycles = this.cycles + 5;this.mbr = this.h;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_8e(): void { /*** adc l ***/
    this.cycles = this.cycles + 5;this.mbr = this.l;this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_8f(): void { /*** adc m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.mar = this.a + this.mbr + this.carry;this.a = this.mar & 0xFF;this.pszv = this.a;this.carry = (this.a & 0x100) >> 8;;
}
...
private opcode_a7(): void { /*** and m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.carry = 0;this.a = this.a & this.mbr;this.pszv = this.a;;
}
...
private opcode_b8(): void { /*** cmp a ***/
    this.cycles = this.cycles + 5;this.mbr = this.a;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_b9(): void { /*** cmp b ***/
    this.cycles = this.cycles + 5;this.mbr = this.b;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_ba(): void { /*** cmp c ***/
    this.cycles = this.cycles + 5;this.mbr = this.c;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_bb(): void { /*** cmp d ***/
    this.cycles = this.cycles + 5;this.mbr = this.d;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_bc(): void { /*** cmp e ***/
    this.cycles = this.cycles + 5;this.mbr = this.e;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_bd(): void { /*** cmp h ***/
    this.cycles = this.cycles + 5;this.mbr = this.h;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_be(): void { /*** cmp l ***/
    this.cycles = this.cycles + 5;this.mbr = this.l;this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
private opcode_bf(): void { /*** cmp m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.mar = this.a - this.mbr;this.pszv = this.mar & 0xFF;this.carry = (this.a & 0x100) >> 8;;
}
...
private opcode_c7(): void { /*** mov a,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.a = this.mbr;;
}
...
private opcode_cf(): void { /*** mov b,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.b = this.mbr;;
}
...
private opcode_d7(): void { /*** mov c,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.c = this.mbr;;
}
...
private opcode_df(): void { /*** mov d,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.d = this.mbr;;
}
...
private opcode_e7(): void { /*** mov e,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.e = this.mbr;;
}
...
private opcode_ef(): void { /*** mov h,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.h = this.mbr;;
}
...
private opcode_f7(): void { /*** mov l,m ***/
    this.cycles = this.cycles + 8;this.mar = ((this.h << 8) | this.l);this.mbr = READ(this.mar);this.l = this.mbr;;
}
private opcode_f8(): void { /*** mov m,a ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.a;WRITE(this.mbr,this.mar);;
}
private opcode_f9(): void { /*** mov m,b ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.b;WRITE(this.mbr,this.mar);;
}
private opcode_fa(): void { /*** mov m,c ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.c;WRITE(this.mbr,this.mar);;
}
private opcode_fb(): void { /*** mov m,d ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.d;WRITE(this.mbr,this.mar);;
}
private opcode_fc(): void { /*** mov m,e ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.e;WRITE(this.mbr,this.mar);;
}
private opcode_fd(): void { /*** mov m,h ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.h;WRITE(this.mbr,this.mar);;
}
private opcode_fe(): void { /*** mov m,l ***/
    this.cycles = this.cycles + 7;this.mar = ((this.h << 8) | this.l);this.mbr = this.l;WRITE(this.mbr,this.mar);;
}
